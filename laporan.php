...
$laporan  = query("SELECT * FROM report ORDER BY No DESC");

// tombol submit ditekan
if (isset($_POST["carilaporan"])) {
    $laporan = carilaporan($_POST["keyword"]);
}
?>
...
<body>
    ...
    <div class="container" style="margin-left: 260px">
        ...
        <form class="form-horizontal" action="" method="post">
            <div class="form-group">
                <div class="col-sm-5">
                    ...
                    <button type="submit" class="btn btn-primary" name="carilaporan">Submit</button>
                </div>
            </div>
        </form>
        ...
        <a href="printlaporan.php" class="btn btn-success" style="border-radius: 20px;" target="blank"><i class="fas fa-print" style="font-size: 25px;"> Print</i></a>
    </div>
