...
<body>
  ...
  <div class="container" style="margin-left: 260px">
    <a href="inputdatakalibrasi.php" class="btn btn-primary" style="border-radius: 20px;">Input Data Kalibrasi</a>
    ...
    <table class="w3-table-all w3-centered table table-bordered">
      ...
      <?php foreach ($kalibrasi as $k) : ?>
        <tr>
          ...
          <td>
            <a href="ubahKalibrasi.php?No=<?= $k['No']; ?>"><i class="fas fa-cog" style="color:grey"></i></a>
            <br>
            <a href="hapusKalibrasi.php?No=<?= $k['No']; ?>" onclick="return confirm('apakah anda yakin?')"><i class="fas fa-trash-alt" style="color: red;"></i></a>
          </td>
        </tr>
        <?php $i++; ?>
      <?php endforeach; ?>
