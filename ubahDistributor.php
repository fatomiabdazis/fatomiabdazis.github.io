...
$d = query("SELECT * FROM m_distributor WHERE No = $no")[0];
...
<body>
  ...
  <div class="container" style="margin-left: 260px">
    ...
    <form class="form-horizontal" action="" method="post">
      <input type="hidden" name="No" id="" value="<?= $d["No"] ?>">
      <div class="form-group">
        <label for="kd_distributor" class="control-label col-sm-2">Kode Distributor :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Kode Distributor" name="kd_distributor" No="kd_distributor" required="" autocomplete="off" value="<?= $d["kd_distributor"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Nama Distributor" name="nama_distributor" No="nama_distributor" required="" autocomplete="off" value="<?= $d["nama_distributor"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        <label for="alamat_distributor" class="control-label col-sm-2">Alamat Distributor :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Alamat Distributor" name="alamat_distributor" No="alamat_distributor" autocomplete="off" value="<?= $d["alamat_distributor"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="No.Telp" name="no_tlp" No="no_tlp" autocomplete="off" value="<?= $d["no_tlp"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Email" name="email" No="email" autocomplete="off" value="<?= $d["email"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Ket" name="ket" No="ket" autocomplete="off" value="<?= $d["ket"]; ?>">
          <br>
        </div>
      </div>
