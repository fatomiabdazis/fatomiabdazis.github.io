  ...
  <div class="container" style="margin-left: 260px">
    ...
    <form class="form-horizontal" action="" method="post">
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Kode Teknisi" name="kd_teknisi" No="kd_teknisi" required="" autofocus="" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Nama Teknisi " name="nama_teknisi" No="nama_teknisi" required="" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        <label for="alamat_teknisi" class="control-label col-sm-2">Alamat :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Alamat Teknisi" name="alamat_teknisi" No="alamat_teknisi" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Telp" name="no_tlp" No="no_tlp" autocomplete="off">
          <br>
        </div>
      </div>
