...
<body>
  ...
  <div class="container" style="margin-left: 260px">
    <a href="inputjadwal.php" class="btn btn-primary" style="border-radius: 20px;">Input Jadwal Pemeliharaan</a>
    ...
    <table class="w3-table-all w3-centered table table-bordered">
      ...
      <?php foreach ($jadwal as $j) : ?>
        <tr>
          ...
          <td>
            <a href="ubahJadwal.php?No=<?= $j['No']; ?>"><i class="fas fa-cog" style="color:grey"></i></a>
            <br>
            <a href="hapusJadwal.php?No=<?= $j['No']; ?>" onclick="return confirm('apakah anda yakin?')"><i class="fas fa-trash-alt" style="color:red"></i></a>
          </td>
        </tr>
        <?php $i++; ?>
      <?php endforeach; ?>
    </table>
    <a href="printjadwal.php" class="btn btn-success" style="border-radius: 20px;" target="blank"><i class="fas fa-print" style="font-size: 25px;"> Print</i></a>
  </div>
