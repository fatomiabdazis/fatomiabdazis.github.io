...
if (isset($_POST["submit"])) {
  ...
  if (tambahDatakalibrasi($_POST) > 0) {
    echo "
        <script>
          alert('data kalibrasi berhasil ditambahkan!');
    ...
    echo "
        <script>
          alert('data kalibrasi gagal ditambahkan!');
          document.location.href = 'kalibrasi.php';
        </script>
    ";
  }
...
<body>
  ...
  <div class="container" style="margin-left: 260px">
    <h3>Input Data Kalibrasi</h3>
    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
      <div class="form-group">
        <label for="kode" class="control-label col-sm-2">Kode Alat :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Kode Alat" name="kode" No="kode" required="" autofocus="" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="S/N" name="sn" No="sn" required="" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        <label for="merk" class="control-label col-sm-2">Merk Alat :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Merk Alat" name="merk" No="merk" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        <label for="alat" class="control-label col-sm-2">Nama Alat :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Nama Alat" name="alat" No="alat" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Tanggal Kalibrasi" name="tgl_kalibrasi" No="tgl_kalibrasi" autocomplete="off">
          <br>
        </div>
      </div>
      <div class="form-group">
        <label for="file" class="control-label col-sm-2">Data :</label>
        <div class="col-sm-5">
          <input type="file" class="form-control" placeholder="Data" name="file" No="file" autocomplete="off">
          <br>
        </div>
      </div>
