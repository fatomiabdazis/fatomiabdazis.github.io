...
$a = query("SELECT * FROM m_alat WHERE No = $no")[0];
...
if (isset($_POST["submit"])) {
  ...
  if (ubahDataalat($_POST) > 0) {
    echo "
        <script>
          alert('Data Alat Medis berhasil berhasil diubah!');
    ...
    echo "
        <script>
          alert('Data Alat Medis berhasil gagal diubah!');
          document.location.href = 'dataalat.php';
        </script>
    ";
  }
...
<body>
  ...
  <div class="container" style="margin-left: 260px">
    <h3>Ubah Data Alat Medis</h3>
    <form class="form-horizontal" action="" method="post">
      <input type="hidden" name="No" id="" value="<?= $a["No"] ?>">
      <div class="form-group">
        <label for="nama_alat" class="control-label col-sm-3">Nama Alat :</label>
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Nama Alat Medis" name="nama_alat" No="nama_alat" required="" autocomplete="off" value="<?= $a["nama_alat"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Merk Alat Medis" name="merk_alat" No="merk_alat" required="" autocomplete="off" value="<?= $a["merk_alat"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="S/N" name="sn_alat" No="sn_alat" autocomplete="off" value="<?= $a["sn_alat"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Jenis Alat Medis" name="jenis_alat" No="jenis_alat" autocomplete="off" value="<?= $a["jenis_alat"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Distributor" name="distributor_alat" No="distributor_alat" autocomplete="off" value="<?= $a["distributor_alat"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Tanggal Pengadaan" name="tgl_pengadaan" No="tgl_pengadaan" autocomplete="off" value="<?= $a["tgl_pengadaan"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Tanggal Pengadaan" name="tgl_penerimaan" No="tgl_penerimaan" autocomplete="off" value="<?= $a["tgl_penerimaan"]; ?>">
          <br>
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" placeholder="Ruangan" name="ruangan_alat" No="ruangan_alat" autocomplete="off" value="<?= $a["ruangan_alat"]; ?>">
          <br>
        </div>
      </div>
